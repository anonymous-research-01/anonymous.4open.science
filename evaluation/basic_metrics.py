    ...
    def metric_eTaPR_F1(self, label, score, preds=None):
        if preds is None:
            ...
            if not np.any(preds):
                ...
                eTaPR_precision, eTaPR_recall, eTaPR_F1 = f1_score_etapr.get_eTaPR_fscore(label, preds, theta_p = 0.5, theta_r = 0.01, delta=0) #Default Settings from the original paper
            debug =1
